...
import com.dsirc.tests.service.mapper.AddressMapper;
...
class AddressResourceIT {
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.addressLine2(UPDATED_ADDRESS_LINE_2).city(UPDATED_CITY).country(UPDATED_COUNTRY);
