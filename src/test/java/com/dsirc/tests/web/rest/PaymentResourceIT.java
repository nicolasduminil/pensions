...
import com.dsirc.tests.service.mapper.PaymentMapper;
...
class PaymentResourceIT {
    ...
    private static final PaymentStatus DEFAULT_PAYMENTS_STATUS = PaymentStatus.COMPLETED;
    private static final PaymentStatus UPDATED_PAYMENTS_STATUS = PaymentStatus.PENDING;
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment().paymentsStatus(DEFAULT_PAYMENTS_STATUS).paymentDate(DEFAULT_PAYMENT_DATE);
        return payment;
    }
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment().paymentsStatus(UPDATED_PAYMENTS_STATUS).paymentDate(UPDATED_PAYMENT_DATE);
        return payment;
    }
    ...
    void createPayment() throws Exception {
        ...
        assertThat(testPayment.getPaymentsStatus()).isEqualTo(DEFAULT_PAYMENTS_STATUS);
    ...
    @Test
    @Transactional
    void checkPaymentsStatusIsRequired() throws Exception {
        int databaseSizeBeforeTest = paymentRepository.findAll().size();
        // set the field null
        payment.setPaymentsStatus(null);
    ...
    void getAllPayments() throws Exception {
        ...
        restPaymentMockMvc
            ...
            .andExpect(jsonPath("$.[*].paymentsStatus").value(hasItem(DEFAULT_PAYMENTS_STATUS.toString())))
    ...
    void getPayment() throws Exception {
        ...
        restPaymentMockMvc
            ...
            .andExpect(jsonPath("$.paymentsStatus").value(DEFAULT_PAYMENTS_STATUS.toString()))
    ...
    void putNewPayment() throws Exception {
        ...
        updatedPayment.paymentsStatus(UPDATED_PAYMENTS_STATUS).paymentDate(UPDATED_PAYMENT_DATE);
        ...
        Payment testPayment = paymentList.get(paymentList.size() - 1);
        assertThat(testPayment.getPaymentsStatus()).isEqualTo(UPDATED_PAYMENTS_STATUS);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.paymentsStatus(UPDATED_PAYMENTS_STATUS).paymentDate(UPDATED_PAYMENT_DATE);
