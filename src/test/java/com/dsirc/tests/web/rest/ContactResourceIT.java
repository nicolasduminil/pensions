...
class ContactResourceIT {
    ...
    public static Contact createEntity(EntityManager em) {
        Contact contact = new Contact().email(DEFAULT_EMAIL).phone(DEFAULT_PHONE);
        return contact;
    }
    ...
    public static Contact createUpdatedEntity(EntityManager em) {
        Contact contact = new Contact().email(UPDATED_EMAIL).phone(UPDATED_PHONE);
        return contact;
    }
    ...
    void putNewContact() throws Exception {
        ...
        updatedContact.email(UPDATED_EMAIL).phone(UPDATED_PHONE);
    ...
    void fullUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.email(UPDATED_EMAIL).phone(UPDATED_PHONE);
