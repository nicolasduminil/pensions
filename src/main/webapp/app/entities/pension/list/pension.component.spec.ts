...
describe('Component Tests', () => {
  describe('Pension Management Component', () => {
    let comp: PensionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PensionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.pensions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
