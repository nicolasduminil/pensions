  ...
  describe('Recipient Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should update editForm', () => {
        ...
        expect(comp.editForm.value).toEqual(expect.objectContaining(recipient));
      });
    });
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        // GIVEN
        const saveSubject = new Subject<HttpResponse<Recipient>>();
        ...
        expect(recipientService.update).toHaveBeenCalledWith(recipient);
      ...
      it('Should call create service on save for new entity', () => {
        ...
        // THEN
        expect(recipientService.create).toHaveBeenCalledWith(recipient);
        expect(comp.isSaving).toEqual(false);
        expect(comp.previousState).toHaveBeenCalled();
      });
