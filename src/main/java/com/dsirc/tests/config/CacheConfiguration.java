...
public class CacheConfiguration {
    ...
    public InfinispanGlobalConfigurer globalConfiguration(JHipsterProperties jHipsterProperties) {
        ...
        return () ->
            GlobalConfigurationBuilder
                ...
                .clusterName("infinispan-pensions-cluster")
                .jmx()
    ...
    public InfinispanCacheConfigurer cacheConfigurer(JHipsterProperties jHipsterProperties) {
        ...
        return manager -> {
            ...
            Stream
                .of(
                    com.dsirc.tests.repository.UserRepository.USERS_BY_LOGIN_CACHE,
                    com.dsirc.tests.repository.UserRepository.USERS_BY_EMAIL_CACHE
                )
                .forEach(
                    cacheName ->
                        manager.defineConfiguration(
